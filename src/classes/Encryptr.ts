...
export default class Encryptr {
    static encrypt = (text: string, masterkey: Buffer | string): string => {
    ...
    static decrypt = (encryptedString: string, masterkey: Buffer | string): string => {
        // base64 decoding
        const bData: Buffer = Buffer.from(encryptedString, 'base64');
